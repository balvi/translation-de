package de.balvi.cuba.translationde;
...
public class TranslationdeTestContainer extends TestContainer {

    public TranslationdeTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/balvi/cuba/translationde/app.properties",
    ...
    public static class Common extends TranslationdeTestContainer {

        public static final TranslationdeTestContainer.Common INSTANCE = new TranslationdeTestContainer.Common();
